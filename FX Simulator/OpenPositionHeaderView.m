...
@implementation OpenPositionHeaderView {
...
-(id)init
{
    if (self = [super init]) {
        ...
        labelList = @[orderNumberLabel, orderTypeLabel, orderRateLabel, orderLotLabel, profitAndLossLabel, orderTimeLabel];
